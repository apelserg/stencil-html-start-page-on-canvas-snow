...
APELSERG.CONFIG.SET.PicSrc = ["snow.jpg"]; //-- заставка канвы
...
APELSERG.CONFIG.SET.StarsNum = 100; //-- число
APELSERG.CONFIG.SET.StarsSize = 3; //-- максимальный размер
APELSERG.CONFIG.SET.StarsMove = 0; //-- максимальная скорость

APELSERG.CONFIG.SET.SnowsNum = 0; //-- число
APELSERG.CONFIG.SET.SnowsSize = 0; //-- максимальный размер
APELSERG.CONFIG.SET.SnowsMove = 0; //-- максимальная скорость
APELSERG.CONFIG.SET.SnowsShift = 30; //-- колебание
...
APELSERG.MAIN.Animation = function () {
    ...
    if (APELSERG.CONFIG.PROC.CntHandle == 1) APELSERG.MODEL.UpdateSnows();
